...
def display(count, x, y, message_format = 'Dodged: %d'):
    """display the score"""
   # max_dodged = 10
    font = pygame.font.SysFont("Roboto-regular.ttf", 20)
...
def message_display(text):
    ...
    largeText = pygame.font.SysFont("Roboto-regular.ttf",115)
...
def crash(x, y):
    ...
    largeText = pygame.font.SysFont("Roboto-regular.ttf",90)
...
def button(msg, x, y, w, h, ic, ac, action=None):
    ...
    smallText = pygame.font.SysFont("Roboto-regular.ttf",20)
...
def game_intro():
    ...
    while intro:
        ...
        largeText = pygame.font.SysFont("Roboto-regular.ttf",100)
        ...
        for event in pygame.event.get():
            ...
            if event.type== pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RIGHT:
                    ...
                    # Använd pilarna för att flytta bilen


                if event.key == pygame.K_p:
                    pause = True
                    game_pause()
                    # Tryck P för att pausa spelet


            if event.type == pygame.KEYDOWN and event.key == pygame.K_a:
                x_change=-5
                # Tryck a för att flytta bilen till vänster

            if event.type == pygame.KEYDOWN and event.key == pygame.K_d:
                x_change=5
                #tryck d för att flytta bilen till höger
